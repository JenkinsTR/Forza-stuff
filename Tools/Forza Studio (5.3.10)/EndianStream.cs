...
namespace ForzaStudio
{
    ...
    public class EndianStream : Stream
    {
        ...
        //private ushort Bswap(ushort value)
        //{
        //    return (ushort)(((value & 0xFF00) >> 8) | (value << 8));
        //}
        //private uint Bswap(uint value)
        //{
        //    return (uint)(((value & 0xFF000000) >> 24) | ((value & 0xFF0000) >> 8) | ((value & 0xFF00) << 8) | (value << 24));
        //}
        #endregion
    }
}
